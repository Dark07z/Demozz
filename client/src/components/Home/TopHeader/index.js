...
const TopHeader = () => {
  ...
  const handleLogout = () => {
    clearAuthUser();
    sessionStorage.removeItem("nike-auth-email");
      ...
      <div className="header-top justify-between flex">
        <Link to="/jordan">
          <div className="svg-top">
            <svg height="22px" width="22px" fill="#111" viewBox="0 0 26 32">
        ...
        <div>
          <nav>
            <ul>
              ...
              {isLoggedIn ? (
                <li
                  className="top-header-account-wrapper"
                  onMouseEnter={() => setIsAccountMenuOpen(true)}
                  onMouseLeave={() => setIsAccountMenuOpen(false)}
                >
                  <button type="button" className="top-header-greeting-btn">
                    Hi, {firstName}
                  </button>
                  ...
                  {isAccountMenuOpen && (
                    <div className="top-header-account-menu" role="menu" aria-label="Account menu">
                      ...
                      <Link to="/favourites" className="top-header-account-link">Favourites</Link>
                      <Link to="/experiences" className="top-header-account-link">Experiences</Link>
                      <Link to="/account-settings" className="top-header-account-link">Account Settings</Link>
                      <button type="button" className="top-header-account-link top-header-logout-btn" onClick={handleLogout}>
                        Log Out
                      </button>
                    </div>
                  )}
