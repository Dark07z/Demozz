...
import Card from "./WomenProducts-Components/Card";
import Gender from "./WomenProducts-Components/Gender";
import HeadText from "./WomenProducts-Components/HeadText";
import Kid from "./WomenProducts-Components/Kid";
import List from "./WomenProducts-Components/List";
import Price from "./WomenProducts-Components/Price";
import Spor from "./WomenProducts-Components/Spor";
import "./Products.css";

const WomenProducts = () => {
  useEffect(() => {
    document.title = "Women's Shoes. Nike VN";
  }, []);
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await fetch("http://127.0.0.1:3001/women");
