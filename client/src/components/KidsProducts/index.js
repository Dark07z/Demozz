...
import Card from "./KidsProducts-Components/Card";
import Gender from "./KidsProducts-Components/Gender";
import HeadText from "./KidsProducts-Components/HeadText";
import Kid from "./KidsProducts-Components/Kid";
import List from "./KidsProducts-Components/List";
import Price from "./KidsProducts-Components/Price";
import Spor from "./KidsProducts-Components/Spor";
import "./Products.css";

const KidsProducts = () => {
  useEffect(() => {
    document.title = "Kids' Shoes. Nike VN";
  }, []);
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await fetch("http://127.0.0.1:3001/kids");
